...
//
// 2026-09-26：补「入学年份」（2021–2030 纯年份）—— 与「入学年月」（26秋季这类学期）是
// **两个不同字段**，招生复盘最常用年份口径。选项来自数据本身（`distinct(all, k)`），
// 无需另配字典；键必须在后端 `DIMENSION_FIELDS` 投影白名单里（否则筛选恒 0），有守卫钉住。
const FILTER_KEYS = ['校区', '当前年级', '入学年月', '入学年份', '是否是新生'] as const;
