      ...
      <div className="page-header">
        <div className="page-header-row">
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-lg)' }}>
            <Link href="/source-followups" className="btn btn-icon" title="返回列表">
          ...
          <div className="page-actions">
            <button className="btn btn-outline btn-sm" onClick={() => router.push('/source-followups')}>{t('backToList')}</button>
          </div>
        </div>
      </div>
