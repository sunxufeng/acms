...
const 沟通主题_OPTS = ['学业', '考勤', '行为', '健康', '活动', '升学', '行政', '其他'];
...
const COLUMNS: CrudColumn[] = [
  ...
  { key: '沟通主题', label: '主题', width: '100px', filter: true, filterOptions: 沟通主题_OPTS, form: true, type: 'select', options: 沟通主题_OPTS },
  { key: '关联监护人', label: '监护人', width: '110px', form: true, type: 'text' },
  { key: '沟通人', label: '沟通人', width: '100px', form: true, type: 'text' },
  { key: '家长反馈态度', label: '家长态度', width: '110px', filter: true, filterOptions: 家长反馈态度_OPTS, form: true, type: 'select', options: 家长反馈态度_OPTS },
  { key: '家长反馈', label: '家长反馈', form: true, type: 'textarea' },
  { key: '待办事项', label: '待办事项', form: true, type: 'textarea' },
  { key: '待办负责人', label: '待办负责人', width: '110px', form: true, type: 'text' },
  { key: '跟进截止日期', label: '截止日期', width: '120px', form: true, type: 'date' },
  ...
  { key: '信息敏感级别', label: '敏感级别', width: '110px', filter: true, filterOptions: 信息敏感级别_OPTS, form: true, type: 'select', options: 信息敏感级别_OPTS },
];
