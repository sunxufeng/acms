...
export const DEFAULT_NAV_MENU_CONFIG: NavMenuConfig = {
  items: [
    ...
    { key: 'teaching', label: '教学班级', enLabel: 'Teaching Classes', href: '/teaching-classes', icon: 'courses', section: '业务管理', order: 30, perm: 'course:read' },
    { key: 'schedule', label: '排课课次', enLabel: 'Schedules', href: '/schedule', icon: 'schedule', section: '业务管理', order: 40, perm: 'schedule:read' },
    { key: 'portal', label: '学生门户', enLabel: 'Student Portal', href: '/portal', icon: 'students', section: '业务管理', order: 50, perm: 'student:read' },

    { key: 'student360', label: '学生全景', enLabel: 'Student 360', href: '/student-360', icon: 'students', section: '学生闭环', order: 10, perm: 'student:read' },
    ...
    { key: 'studentAttendances', label: '学生考勤', enLabel: 'Attendance', href: '/student-attendances', icon: 'students', section: '学生闭环', order: 30, perm: 'attendance:read' },
    ...
    { key: 'dailyFollowups', label: '日常跟进', enLabel: 'Daily Follow-ups', href: '/daily-followups', icon: 'notifications', section: '学生闭环', order: 70, perm: 'followup:read' },
    { key: 'studentObservations', label: '学生观察', enLabel: 'Student Observations', href: '/student-observations', icon: 'students', section: '学生闭环', order: 72, perm: 'student:read' },
    { key: 'idpPlans', label: 'IDP管理', enLabel: 'IDP Plans', href: '/idp-plans', icon: 'target', section: '学生闭环', order: 75, perm: 'student:read' },
    ...
    { key: 'settlements', label: '月度结算', enLabel: 'Monthly Settlements', href: '/settlements', icon: 'billing', section: '教师管理', order: 40, perm: 'billing:read' },
    { key: 'adjustments', label: '调整冲销', enLabel: 'Adjustments', href: '/adjustments', icon: 'billing', section: '教师管理', order: 50, perm: 'billing:read' },
