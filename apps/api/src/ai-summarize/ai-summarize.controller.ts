...
import { HOME_SCHOOL_COMMS_CONFIG, DAILY_FOLLOWUP_CONFIG, SOURCE_FOLLOWUP_CONFIG, STUDENT_OBSERVATION_CONFIG, type AiSummarizeTableConfig } from './ai-summarize.config.js';
...
@Controller('student-observations-ai')
@UseGuards(SessionGuard)
export class StudentObservationAiController extends AiSummarizeController {
  constructor(svc: AiSummarizeService) {
    super(svc, STUDENT_OBSERVATION_CONFIG);
  }
}
