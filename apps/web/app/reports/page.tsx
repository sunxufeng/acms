...
const REPORTS: ReportDef[] = [
  { key: 'overview', label: '学生结构概览', desc: '在校人数、性别比、新生占比等核心指标', dims: '年级 · 性别 · 入学年份', ready: true },
  ...
  { key: 'notes', label: '笔记统计', desc: '按人统计某段时间新增多少笔记、转了多少次', dims: '按人 · 来源 · 模块 · 趋势', ready: true },
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 'var(--font-sm)', color: 'var(--fg-tertiary)', margin: '0 0 1rem' }}>
        {tl('学生维度统计报表')} · {tl('筛选后')} {rows.length} / {total} {tl('人')}
      </p>
